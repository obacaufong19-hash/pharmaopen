...
function UpdateForm() {
  ...
  if (!pharmacy) return <div className="p-10 text-center text-white">Authenticating...</div>;
  ...
  return (
    <div className="max-w-md mx-auto p-8 text-center bg-slate-900 min-h-screen text-white">
      ...
      <div 
        ...
        className={`w-48 h-48 mx-auto rounded-full flex items-center justify-center cursor-pointer transition-all active:scale-95 shadow-2xl ${
